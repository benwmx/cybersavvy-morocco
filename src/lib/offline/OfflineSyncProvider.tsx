...
import { syncPublicScenarios, syncPrivateScenarios, scrubPrivateData, syncTranslations } from "./syncService";
...
export function OfflineSyncProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const runSync = async () => {
      setSyncing(true);
      try {
        await Promise.all([syncPublicScenarios(), syncTranslations()]);
